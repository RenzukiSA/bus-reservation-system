...
async function insertSampleData(client) {
    try {
        ...
        for (const bus of buses) {
            const busRes = await client.query('INSERT INTO buses (bus_number, type, capacity, status) VALUES ($1, $2, $3, $4) RETURNING id', [bus.number, bus.type, bus.capacity, bus.status]);
            ...
            for (let i = 1; i <= bus.capacity; i++) {
                ...
                await client.query('INSERT INTO seats (bus_id, seat_number, seat_type, price_modifier) VALUES ($1, $2, $3, $4)', [busId, i.toString(), seatType, priceModifier]);
            }
        }
        // Insertar rutas
        await client.query(`
